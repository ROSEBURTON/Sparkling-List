...
class SodaGradientView: UIView {
    ...
    private func animateToNextGradient() {
        Is_Animating = true
        //print("\(Gradient_Layer.opacity)% soda opacity")
    ...
    override func layoutSubviews() {
        ...
        Gradient_Layer.opacity = Float(opacityPercentage)

        Gradient_Layer.frame = bounds
    }
}

extension SodaGradientView: CAAnimationDelegate {
