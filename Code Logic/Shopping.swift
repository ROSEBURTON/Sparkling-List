...
var deleteSoundOptions = ["1970s Transmitter", "@*!+-R", "Aflame Procrasination", "Assimilation", "Big Purr", "Chalkboard", "Coming Near You", "Cybernetic Models", "Dealt With", "Deep Space", "Fart", "Glass Shatter", "Gyat Chonki-Lonki", "Laser", "Last Meal", "Little Purr", "Loading Productive Ammo", "Lost Signal", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "PB & J", "Pleased Watching Mantid", "Productivit-Yee-Yee", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Static", "Submerge", "Type Ship", "Vegan Muncher", "GoReady", "Noted", "Productive Prep", "Water Lurk", "Morning Hit"]
...
public class SHOP: UIViewController, MFMailComposeViewControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    @IBAction func illuminate_Selection(_ sender: UIButton) {
        Clicky()
        let selectedEntity = "DJ Starship & TORQ"
        UserDefaults.standard.set(selectedEntity, forKey: "Selected_AI_Entity")
        if let selectedEntity = UserDefaults.standard.string(forKey: "Selected_AI_Entity") {
            print("Selected AI Entity: \(selectedEntity)")
