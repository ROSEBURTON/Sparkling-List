...
var deleteSoundOptions = ["@*!+-R", "Aflame Procrasination", "Assimilation", "Calculated", "Chalkboard", "Cybernetic Models", "Dealt With", "Deep Space", "Electro Shock", "Fart", "Glass Shatter", "Hotel Pool", "Laser", "Last Meal", "Loading Productive Ammo", "Lost Signal", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "Pleased Watching Mantid", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Static", "Submerge", "Type Ship", "Vegan Muncher", "Registered", "Candor Cold"]
