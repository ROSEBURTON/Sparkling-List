...
var deleteSoundOptions = ["@*!+-R", "Aflame Book Burners", "Assimilation", "Audio Interference", "Beyond the Lies", "Big Purr", "Blasted", "Buzzed Up", "Chalkboard", "Coming Near You", "Cybernetic Models", "Dealt With", "Dented Metal", "Fart", "Glass Shatter", "Toxic Combo Book burning discrediting lying gaslighters", "Gold", "Gyat Chonki-Lonki", "Laser", "Loading Productive Ammo", "Pleased Observing Mantid", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "PB & J", "Productive Prep", "Ready for Takeoff", "Sea Mine", "Signal", "Submerge", "Type Ship", "Vegan Muncher", "W.A.S.P", "Water Lurk", "Within the void"]
