...
var deleteSoundOptions = ["@*!+-R", "Aflame Procrasination", "Assimilation", "Calculated", "Chalkboard", "Cybernetic Models", "Dealt With", "Deep Space", "Electro Shock", "Fart", "Glass Shatter", "Laser", "Last Meal", "Loading Productive Ammo", "Lost Signal", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "Pleased Watching Mantid", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Static", "Submerge", "Type Ship", "Vegan Muncher", "Gyat Chonki-Lonki", "1970s Transmitter", "Coming Near You", "PB & J", "Purr", "Big Purr", "Random Boi", "Productivit-Yee-Yee"]
