...
var deleteSoundOptions = ["1970s Transmitter", "@*!+-R", "Aflame Procrasination", "Assimilation", "Big Purr", "Chalkboard", "Coming Near You", "Cybernetic Models", "Dealt With", "Deep Space", "Fart", "Glass Shatter", "Gyat Chonki-Lonki", "Laser", "Last Meal", "Loading Productive Ammo", "Lost Signal", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "PB & J", "Pleased Watching Mantid", "Productivit-Yee-Yee", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Static", "Submerge", "Type Ship", "Vegan Muncher", "GoReady", "Noted", "Productive Prep", "Water Lurk", "Morning Hit", "Buzzed Up"]
