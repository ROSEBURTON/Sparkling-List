...
var deleteSoundOptions = ["Aflame Procrasination", "Assimilation", "Calculated", "@*!+-R", "Chalkboard", "Cybernetic Models", "Dealt With", "Electro Shock", "Fart", "Glass Shatter", "Hotel Pool", "Laser", "Last Meal", "Loading Productive Ammo", "Lost Signal", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "Out of Bounds", "Pleased Watching Mantid", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Static", "Submerge", "Vegan Muncher", "Барыня"]
...
public class SHOP: UIViewController, MFMailComposeViewControllerDelegate, UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    var flashingColors: [UIColor] = [.red, .blue, .green, .yellow]
...
//https://www.linkedin.com/in/orioncait/details/skills/
