...
var deleteSoundOptions = ["@*!+-R", "Aflame Book Burners", "Assimilation", "Big Purr", "Blasted", "Buzzed Up", "Chalkboard", "Coming Near You", "Cybernetic Models", "Dealt With", "Dented Metal", "Far Outta Here Skatin\' Rink", "Fart", "Glass Shatter", "GoReady", "Gold", "Gyat Chonki-Lonki", "Laser", "Loading Productive Ammo", "Mantid\'s Observation", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "PB & J", "Pleased Watching Mantid", "Productive Prep", "Ready for Takeoff", "Sea Mine", "Signal", "Static", "Submerge", "Type Ship", "Vegan Muncher", "Water Lurk", "Within the void", "Beyond the Lies", "W.A.S.P"]
...
public class SHOP: UIViewController, UIPickerViewDataSource, UIPickerViewDelegate, UITableViewDelegate, UITableViewDataSource, SKRequestDelegate, SKPaymentTransactionObserver, SKProductsRequestDelegate {
    ...
    func AutoPaymentSuggest() {
        if let product = subscriptionProduct {
            ...
            let alertController = UIAlertController(title: "Subscribe", message: "Subscribe for \(formattedPrice) a week", preferredStyle: .alert)
    ...
    func fetchSubscriptionProduct() {
        let productIdentifiers: Set<String> = ["subscription_product_identifier"]
