...
var deleteSoundOptions = ["generated_audio", "ATL Night Rain", "Aflame Procrasination", "Assimilation", "Calculated", "Censorship", "Chalkboard",  "Cybernetic Models", "DJ Spider Time", "Electro Shock", "Fart", "Hotel Pool", "Insectoid\'s Observation", "Laser", "Lost Signal", "Last Meal", "Loading Productive Ammo", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "Omit", "Out of Bounds", "Pleased Watcher", "Ready for Takeoff", "Rewiring", "Sea Mine", "Signal", "Submerge", "Vegan Muncher", "Барыня", "黑色影子被捕捉到观看"]
