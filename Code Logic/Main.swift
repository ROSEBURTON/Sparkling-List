...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate {
    ...
    let songNames = [ "LIFI PowerPod", "Night Snow Cleats", "VIBROV", "Chromed & Neutralized", "Distraught Commander", "Southern Dark N' Oily",  "Blue Waters", "Space Race",]
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        // Create a random color for the rectangle
        ...
        // Create a random-sized rectangle with the random color
        ...
        let coloredRect = UIView(frame: randomRect)
        coloredRect.backgroundColor = randomColor
        view.addSubview(coloredRect)
        ...
        UIView.animate(withDuration: 1.0, animations: {
            ...
            coloredRect.removeFromSuperview()
        }
    }
