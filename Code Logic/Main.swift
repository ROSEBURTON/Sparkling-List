...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    let motivators = [
        ...
        "Strive for high ethics and know your enemy as an immune cell",
        ...
        "Mutual symbiosis over possession"
    ]
    ...
    let SongNames = [ "LIFI PowerPod", "Night Snow Cleats", "VIBROV", "Neutrophil Alert and SWAT", "Supreme Commander", "Cards Hidden Tables Turned", "Space Race",]
...
//            guard let self = self else { return }
    ...
    func Current_Companion() {
        if (CurrentActions < 3650 && selectedEntity == "TAGUR") || (selectedEntity == nil) {
            ...
            GifPlayer().PlayGif(named: "TAGUR_zero", within: Current_AI)
        ...
        if CurrentActions > 3650 && CurrentActions < 7300 && selectedEntity == "TAGUR" {
            Scribble.layer.opacity = 1.0
            GifPlayer().PlayGif(named: "TAGUR_Low", within: Current_AI)
            GifPlayer().PlayGif(named: "Scribble", within: Scribble)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
            print("Low")
        ...
        if CurrentActions > 7300 && CurrentActions < 10950 && selectedEntity == "TAGUR" {
            Scribble.layer.opacity = 1.0
            GifPlayer().PlayGif(named: "TAGUR_Steady", within: Current_AI)
            GifPlayer().PlayGif(named: "Scribble", within: Scribble)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
            print("Steady")
        ...
        if CurrentActions > 10950 && CurrentActions < 14600 && selectedEntity == "TAGUR" {
            Scribble.layer.opacity = 1.0
            GifPlayer().PlayGif(named: "TAGUR_Rising", within: Current_AI)
            GifPlayer().PlayGif(named: "Scribble", within: Scribble)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
            print("Rising")
        ...
        if CurrentActions > 18250 && selectedEntity == "TAGUR" {
            Scribble.layer.opacity = 1.0
            GifPlayer().PlayGif(named: "TAGUR_Optimal", within: Current_AI)
            GifPlayer().PlayGif(named: "Scribble", within: Scribble)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
            print("Optimal")
        ...
        if selectedEntity == "Sunday" {
            ...
            GifPlayer().PlayGif(named: "Sunday", within: Current_AI)
        ...
        if selectedEntity == "Starship & TORQ" {
            Current_AI.layer.zPosition = -1
            GifPlayer().PlayGif(named: "Starship & TORQ", within: Current_AI)
