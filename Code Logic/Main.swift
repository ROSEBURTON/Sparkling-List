...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate {
    let motivationalStrings = [
        ...
        "You could do things based on how it will affect the next seven generations, not just the first one",
        ...
        "You can either change what you do or how guilty you feel about it - *Chris Croft",
        "You Don't Reap What You Don't Sow",
        "Laziness can be a big source of unhappiness - Chris Croft",
        "We look for distraction to escape an uncomforable emotional sensation, are you resolving or avoiding? - Nir Eyal",
        "What would be the thing that at the end of the day if I didn't do it, I would be upset with myself about? - Pete Mockaitis",
        "What's the one thing I can do such that by doing it everything else will be easier or unnecessary? - Pete Mockaitis",
        "Spoil your movie and get to it",
        "Take action. Become a formidable foe",
        "Evil is self-destructive, there is only so far it can go before dissolving into itself - Cosmic Agency",
        "Addressing or avoiding? Put what's dreaded to rest. R.I.P I took action.",
        "Give spice to your life sauce - Cosmic Agency"
    ]
    ...
    let songNames = [ "LIFI PowerPod", "Night Snow Cleats", "VIBROV", "Chromed & Neutralized", "Distraught Commander", "Southern Dark N' Oily", "Space Race",]
    ...
    let placeholder_strings = [
        ...
        "Sit back, know the root of the problem, annihilate the issue",
