...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate {
    ...
    func playNextSong() {
        ...
        colorTransitionTimer = Timer.scheduledTimer(withTimeInterval: 3, repeats: true) { timer in
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        UIView.animate(withDuration: 1.0, animations: {
            ...
            // Abruptly change color and size 4 times
        ...
        UIView.animate(withDuration: 1.0, animations: {
            ...
            coloredRect.frame = CGRect(x: 0, y: 0, width: 200, height: 200)
        }
        UIView.animate(withDuration: 1.0, animations: {
            coloredRect.backgroundColor = UIColor.purple
            coloredRect.frame = CGRect(x: 0, y: 0, width: 250, height: 250)
        }) { _ in
            // Remove containerView after all animations complete
...
//        sys.path.append(Bundle.main.path(forResource: "Sparkling_List", ofType: "py")!)
//        let artificialPythonCode = Python.import("Sparkling_List")
//        artificialPythonCode.say_hello()
    }
        ...
        if indexPath.row < Combined_missions.count {
            ...
            if let missionEntity = task as? MissionEntity {
                ...
                Timer.scheduledTimer(withTimeInterval: 3, repeats: true) { timer in
                    ...
                    let newColor = self.transitionColor(from: currentColor, to: nextColor, progress: 3) // Adjust progress value as needed
