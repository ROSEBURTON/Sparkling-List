...
public override func viewDidAppear(_ animated: Bool) {
    ...
    @IBOutlet weak var List_Preview: UILabel!
    @IBOutlet weak var Left_Two_Row: UILabel!
    @IBOutlet weak var Right_Two_Row: UILabel!
    ...
    public override func viewDidLoad() {
        ...
        List_Preview.font = UIFont(name: "Namecat", size: 20.0)
        Left_Two_Row.font = UIFont(name: "Namecat", size: 20.0)
        Right_Two_Row.font = UIFont(name: "Namecat", size: 20.0)
