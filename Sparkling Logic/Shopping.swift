...
var deleteSoundOptions = ["@*!+-R", "Bakin' Dat Pizza", "Pink Gladiate Soda", "Rainbow Chromium Finish", "Thrist Trappin' Soda", "Chalkboard", "Coming Near You", "Cybernetic Models", "Astral Melt", "Flight 👁️‍🗨️ Freeze, or Exploit", "Fart", "Wine Glass", "Gold for Galactic Drinks", "Gyat Chonki-Lonki Party Butt Bounce", "Laser", "Loading Productive Ammo", "Miss Computer Email", "Missile Hit", "Nuclear Ending", "Pleased Observing Mantid", "Productive Prep", "Ready for Takeoff", "Soda Sea Mine", "Sparkling Status Signal", "Green Lime, Sour Pink Splash", "Book burn, discredit,  gas light", "Type Ship", "I eat grass", "Water Lurk", "Naughty Laser Spank", "Double Foam Root Beers", "Click Back", "Jet Chroma", "Eye Candy", "Building Computer Power Down", "DJ Black Pizza", "Dolphin Signal", "Bubbles", "Boxing", "Dissolved", "Loaded", "Wetter", "Crushed Stones", "Occult", "Task Down", "Controlled Boomerang", "Conversation", "Registered In", "Violated", "Berry Pie", "Female", "Distress Call In The Distance", "Moist", "Owl", "Drop", "Card Handle", "Vase Break", "Window Shatter", "Sword Hit", "Slash", "Watered Down", "Stumble", "Curious", "Glurped", "Static Boing", "AAH", "Dizi Sunlight", "Time Begins", "Early Riser", "Wet Rocks", "Coin Spill", "Cold Iced Splash", "Zip Up", "Powering Up", "Party Horn", "Thunder Shock", "Well Thunder Hit", "Deep Cyber Thunder", "Game Laser", "Gear", "Telegraph", "Transmitting", "Vibrens", "Target Hit", "Triple Fire", "Loading Down", "XliNo RED", "Very Hitting", "Blue Warpings", "Pouring Cake Batter", "Fried Chicken", "Both Sides Please", "A Good Heating", "Whole Egg Consumption", "Ultra Moist Bite", "Inner Soundwave", "Hungry Chaos", "Bad Denial", "Rocky Water Run", "Hot and Ready Kebab", "Digging Up Mess", "All Fired Up", "Cook Burn", "Gravel", "Sonic Whistle", "Dawg In Me", "Turning Up", "Ethoric", "Backwards", "Well-Aimed", "Flipped In", "Superping", "In Click", "Bionic Dolphin Snort", "Skurting", "Tri Ten", "Selection", "Nasal Honk", "Bubble Gum", "Veggie Bite", "Fruity Peach Bite", "Mating Dance", "RigNut", "White Interior Craft Communication", "Possession", "EurickEurick", "DJ Trippin'", "Mixing Space Cake Batter", "Laughing", "Fast Chain", "NO", "Chicago Corporation", "Throwing It Back Along The Way"].sorted()
