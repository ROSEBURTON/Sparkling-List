...
/*
 ...
 git remote add origin https://github.com/ROSEBURTON/Sparkling-List.git
 git branch -M main
 git push -u origin main
 */
/*
...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    let motivators = [
        ...
        "Weak foundations are easy to dismantle and dissapate with knowledge and action",
        "Every door you open closes countless others, shaping the landscape of your potential futures.",
    ...
    let SongNames = [ "Night Snow Cleats", "Neutrophil SWAT Alert", "Supreme Commander", "All Chromed Out", "DROID DOGLET", "Paranormal Starship", "Astrally Slipped Out", "SOUR CUBES", "Emerging"]
