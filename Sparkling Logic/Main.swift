...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    let motivators = [
        ...
        "Wake up with determination, go to bed with satisfaction and not regret.",
        ...
        "*Are you making progress or justifications - Scott Mautz",
        ...
        "Send negativity packing out of your range of influence, make sure undesired thoughts don't live rent-free in your mind.",
        ...
        "Your body / decoder is the goverment of your cells, use it wisely to navigate life",
        "It's never too late to be what you might have been.",
        "The only thing standing between you and your goal is the story you keep telling yourself as to why you can't achieve it.",
        "Every door you open closes countless others, shaping your potential futures.",
        "You can't have a million-dollar dream with a minimum-wage work ethic. - Stephen C. Hogan",
        "The victim mindset dilutes the human potential. By not accepting personal responsibility for our circumstances, we greatly reduce our power to change them. - Steve Maraboli",
        "Your mindset determines your destiny. Choose empowerment over victimhood.",
        "The image of your kind is your resposibility, every decision alters that collective image",
        "Where you're at currently is a reflection of the sum of your thoughts and actions",
        "Trade the illusion of having potential for the reality of achievement today.",
        "Your Vibe Attracts Your Tribe",
        "Consumerism can be addicting, get clean and clear-headed",
        "No one is more invested in you than yourself. Take initiative.",
        "Avoid wasting time and painting over garbage",
        "Does this choice fuel or extinguish your fire?",
        "No excuses",
        "Defeat fear by attacking it",
        "🇦🇫 🇦🇱 🇩🇿 🇦🇩 🇦🇴 🇦🇮 🇦🇬 🇦🇷 🇦🇲 🇦🇺 🇦🇹 🇦🇿 🇧🇸 🇧🇭 🇧🇩 🇧🇧 🇧🇾 🇧🇪 🇧🇿 🇧🇯 🇧🇹 🇧🇴 🇧🇦 🇧🇼 🇧🇷 🇧🇳 🇧🇬 🇧🇫 🇧🇮 🇨🇻 🇰🇭 🇨🇲 🇨🇦 🇨🇫 🇹🇩 🇨🇱 🇨🇳 🇨🇴 🇰🇲 🇨🇩 🇨🇬 🇨🇷 🇭🇷 🇨🇺 🇨🇾 🇨🇿 🇩🇰 🇩🇯 🇩🇲 🇩🇴 🇪🇨 🇪🇬 🇸🇻 🇬🇶 🇪🇷 🇪🇪 🇸🇿 🇪🇹 🇫🇯 🇫🇮 🇫🇷 🇬🇦 🇬🇲 🇬🇪 🇩🇪 🇬🇭 🇬🇷 🇬🇩 🇬🇹 🇬🇳 🇬🇼 🇬🇾 🇭🇹 🇭🇳 🇭🇺 🇮🇸 🇮🇳 🇮🇩 🇮🇷 🇮🇶 🇮🇪 🇮🇱 🇮🇹 🇨🇮 🇯🇲 🇯🇵 🇯🇴 🇰🇿 🇰🇪 🇰🇮 🇽🇰 🇰🇼 🇰🇬 🇱🇦 🇱🇻 🇱🇧 🇱🇸 🇱🇷 🇱🇾 🇱🇹 🇱🇺 🇲🇬 🇲🇼 🇲🇾 🇲🇻 🇲🇱 🇲🇹 🇲🇭 🇲🇷 🇲🇺 🇲🇽 🇫🇲 🇲🇩 🇲🇨 🇲🇳 🇲🇪 🇲🇦 🇲🇿 🇲🇲 🇳🇦 🇳🇷 🇳🇵 🇳🇱 🇳🇿 🇳🇮 🇳🇪 🇳🇬 🇰🇵 🇲🇰 🇲🇵 🇳🇴 🇴🇲 🇵🇰 🇵🇼 🇵🇸 🇵🇦 🇵🇬 🇵🇾 🇵🇪 🇵🇭 🇵🇱 🇵🇹 🇶🇦 🇷🇴 🇷🇺 🇷🇼 🇼🇸 🇸🇲 🇸🇹 🇸🇦 🇸🇳 🇷🇸 🇸🇨 🇸🇱 🇸🇬 🇸🇰 🇸🇮 🇸🇧 🇸🇴 🇿🇦 🇸🇸 🇪🇸 🇱🇰 🇸🇩 🇸🇷 🇸🇪 🇨🇭 🇸🇾 🇹🇼 🇹🇯 🇹🇿 🇹🇭 🇹🇱 🇹🇬 🇹🇴 🇹🇹 🇹🇳 🇹🇷 🇹🇲 🇹🇻 🇺🇬 🇺🇦 🇦🇪 🇬🇧 🇺🇸 🇺🇾 🇺🇿 🇻🇺 🇻🇦 🇻🇪 🇻🇳 🇾🇪 🇿🇲 🇿🇼"
    ].sorted()
    ...
    let SongNames = [ "Night Snow Cleats", "Neutrophil SWAT Alert", "Supreme Commander", "All Chromed Out", "Paranormal Starship", "Astrally Slipped Out", "Emerging", "Bouncin' Bumpin'", "八哥鸟", "Goofy Bouncy Castle", "New White Airport"]
    ...
    @objc func Sparkling_Label_Color_Status() {
        ...
        if let newYearActions = UserDefaults.standard.value(forKey: "New_Year_Actions") as? Int {
            ...
            if let dayOfYear = calendar.ordinality(of: .day, in: .year, for: CurrentDate) {
                ...
                let installationDate = UserDefaults.standard.object(forKey: "InstallationDates") as? Date ?? Date()
                let daysSinceInstallation = calendar.dateComponents([.day], from: installationDate, to: Date()).day ?? 0
                let totalActionsSinceInstallation = daysSinceInstallation * 50
                let currentDate = Date()
                let dateFormatter = DateFormatter()
                dateFormatter.dateStyle = .medium
                dateFormatter.timeStyle = .short
                let formattedInstallationDate = dateFormatter.string(from: installationDate)
                let formattedCurrentDate = dateFormatter.string(from: currentDate)
                print("Current points: \(newYearActions) out of where you should be at by this date since installation: \(totalActionsSinceInstallation)")
                if newYearActions >= totalActionsSinceInstallation {
                    print("Great you reached \(points) out of \(totalActionsSinceInstallation) actions needed currently this year")
                    ...
                    print("\n\nYou need to take \(actionsNeeded) more actions today to turn the label green. Because the installation date of \(formattedInstallationDate) * 50 until this current date of \(formattedCurrentDate) is \(totalActionsSinceInstallation).")
                    UIView.transition(with: Points_YearLabel, duration: transitionDuration, options: .transitionCrossDissolve, animations: {
    ...
    func Current_Companion() {
        ...
        if selectedEntity == "Disco" {
            GifPlayer().PlayGif(named: "Disco", within: Current_AI)
            Current_AI.transform = CGAffineTransform(translationX: 20, y: 0).concatenating(CGAffineTransform(scaleX: 1.2, y: 1.2))
        ...
        if CurrentActions > goalQuarter * 2 && CurrentActions < goalQuarter * 3 && selectedEntity == "ASTRAL" {
            print("You selected the tiger named astral")
            GifPlayer().PlayGif(named: "ASTRAL_MEDIUM", within: Current_AI)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
        }
        
        if CurrentActions > goalQuarter * 3 && CurrentActions < goalQuarter * 4 && selectedEntity == "ASTRAL" {            GifPlayer().PlayGif(named: "ASTRAL_RISING", within: Current_AI)
            Current_AI.transform = CGAffineTransform(scaleX: 1.0, y: 1.0)
            Current_AI.contentMode = .scaleAspectFill
        }
    ...
    @IBAction func silence_radio(_ sender: UIButton) {
            isSilent.toggle()
    ...
    var audioInterruptionTimer: Timer?
    let radio_colors: [UIColor] = [.blue, .yellow, .magenta, .cyan]
    ...
    @objc func playNextSongAfterInterruption() {
        PlayNextSong()
    }
    ...
    @objc func handleAudioInterruption(notification: Notification) {
        ...
        case .began:
            audioInterruptionTimer?.invalidate()
            audioInterruptionTimer = Timer.scheduledTimer(timeInterval: 5.0, target: self, selector: #selector(playNextSongAfterInterruption), userInfo: nil, repeats: false)
        case .ended:
            break
        @unknown default:
            break
    ...
    func PlayNextSong() {
        ...
        colorTransitionTimer = Timer.scheduledTimer(withTimeInterval: 0.50, repeats: true) { timer in
        ...
        do {
            ...
            } else {  audioPath = Bundle.main.path(forResource: SongName, ofType: "wav")
                if let audioPath = audioPath {
                    if !isSilent {
                        Song_Radio = try AVAudioPlayer(contentsOf: URL(fileURLWithPath: audioPath))
                        Song_Radio?.numberOfLoops = 0
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        complimentLabel.backgroundColor = [UIColor.red, UIColor.orange, UIColor.yellow, UIColor.green, UIColor.blue, UIColor.systemIndigo, UIColor.systemPink].randomElement()!.withAlphaComponent(0.7)
        ...
        complimentLabel.lineBreakMode = .byWordWrapping
            let compliments = ["🌏", "New Year New Me", "🧃Juiced up🧃", "You're making progress!", "🍾 Sparkling! 🍾", "Resolutions here I come!", "Bring productive in style", "??¿¿??", "!!¡¡!!", "˥˥˥", "EE¡¡ƎƎ¡¡EE",  "<0>___<0>",  "🧃Soda saturated!🧃"]
        if Compliment_Index >= compliments.count {
            Compliment_Index += 1
            complimentLabel.text = compliments[Compliment_Index]
        } else {
            Compliment_Index = 0
        }
        ...
        let labelX = (screenWidth - labelWidth) / 1.5
        let labelY = (screenHeight - labelHeight) / 1.5
    ...
    func Tilting_Drink() {
        ...
        motionManager.startDeviceMotionUpdates(to: .main) { [weak self] (motion, error) in
            ...
            let soundFile = isTippingLeft ? "Pour Drank" : (isTippingRight ? "Soda Tilt" : nil)
            ...
            if let file = soundFile, let mp3URL = Bundle.main.url(forResource: file, withExtension: "wav") {
                ...
                do {
                    ...
                    self?.listDeletionSound?.volume = 0.7
    ...
    public override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(handleAudioInterruption(notification:)), name: AVAudioSession.interruptionNotification, object: AVAudioSession.sharedInstance())
        ...
        if paying_customer {
            if let mp3URL = Bundle.main.url(forResource: list_sound, withExtension: "mp3") {
                do {
                    ...
                    Extra_sounds?.rate = Float.random(in: 0.6...1.4)
                    Extra_sounds?.play()
                } catch {}
    ...
    var Quote_Index: Int {
        get {
            return UserDefaults.standard.integer(forKey: "Quote_Index")
        }
        set {
            UserDefaults.standard.set(newValue, forKey: "Quote_Index")
        }
    }
    
    var Compliment_Index: Int {
        get {
            return UserDefaults.standard.integer(forKey: "Compliment_Index")
        }
        set {
            UserDefaults.standard.set(newValue, forKey: "Compliment_Index")
        }
    }
