...
//let builder = MLImageClassifier(trainingData: MLImageClassifier.DataSource)
...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    let motivators = [
        ...
        "Send negativity packing out of your range of influence, ensure undesired thoughts don't live rent-free in your mind.",
        ...
        "The more you delay addressing the question, the longer the task remains incomplete, or even worse, gets done incorrectly.",
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
        ...
        complimentLabel.lineBreakMode = .byWordWrapping
            let compliments = ["🌏", "🇧🇷", "🇸🇰", "🇯🇵", "🇰🇷", "New Year New Me", "🧃Juiced up🧃", "You're making progress!", "🍾 Sparkling! 🍾", "Resolutions here I come!", "Bring productive in style", "??¿¿??", "!!¡¡!!", "˥˥˥", "EE¡¡ƎƎ¡¡EE",  "<0>___<0>",  "<|◣_◢|>",  "🧃Soda saturated!🧃"]
