...
//        print("To reach the OPTIMAL level you need to reach \(years_actions_goal) actions or more.")
    ...
    @objc func handleTap(_ sender: UITapGestureRecognizer) {
            ...
            let compliments = ["🌏", "🇧🇷", "🇸🇰", "🇯🇵", "🇰🇷", "Great job!", "Keep up the good work!", "You're doing fantastic!", "New Year New Me", "Juiced up", "You're making progress!", "🍾 Sparkling! 🍾", "Resolutions here I come!", "Bring productive in style", "??¿¿??", "!!¡¡!!", "Ɑ+˥˥ ⱭⱭ ", "EE¡¡ƎƎ¡¡EE",  "<0>___<0>", ";-)", ">:)", ">:D","=^.^=", "(O_O)", "<|-_-|>",  "(◣_◢)"]
