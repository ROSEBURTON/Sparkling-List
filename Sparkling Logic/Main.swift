...
class Main: UIViewController, UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, NSFetchedResultsControllerDelegate, SKStoreProductViewControllerDelegate, AVAudioPlayerDelegate, AVSpeechSynthesizerDelegate {
    ...
    let SongNames = [ "Night Snow Cleats", "Neutrophil SWAT Alert", "Supreme Commander", "All Chromed Out", "Paranormal Starship", "Astrally Slipped Out", "Emerging", "Bouncin' Bumpin'", "Navigating Gallium Sphere", "八哥鸟"]
...
//            }
    ...
    let radio_colors: [UIColor] = [.red, .red, .blue, .green, .green, .yellow]
